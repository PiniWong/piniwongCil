...
const createCommands = () =>{
    ...
    program
      ...
      .description('add vue base view router config,例如：piniwong addbase-R register [-d 1：chilename//创建的metatitle 2：src/router/view//路由文件]')
      .action((name,options)=>{
    ...
    program
      ...
      .description('add vue page child router config,例如：piniwong addchil-R register  fatherCompname  [-d 1：chilename//创建的metatitle 2：src/router/view//路由文件]')
